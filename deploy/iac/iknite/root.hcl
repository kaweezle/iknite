...
locals {
  ...
  kubernetes_version = get_env("KUBERNETES_VERSION", "1.35.1")
  iknite_version     = get_env("IKNITE_NUMBER_VERSION", try(jsondecode(file("${get_repo_root()}/dist/metadata.json")).version, "0.6.1-devel"))
}
