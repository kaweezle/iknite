#!/bin/bash
# cSpell: words echoerr envsubst helmfiled myrelease crds
...
# NOTE: helmfile pukes if both helmfile.yaml and helmfile.d are present (and -f isn't explicitly used)
