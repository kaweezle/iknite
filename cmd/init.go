...
func newCmdInit(out io.Writer, initOptions *initOptions) *cobra.Command {
	...
	initRunner.AppendPhase(iknphase.NewPrepareHostPhase())
...
func newInitOptions() *initOptions {
	...
	externalClusterCfg.Networking.PodSubnet = "10.244.0.0/16"
...
func newInitData(cmd *cobra.Command, args []string, initOptions *initOptions, out io.Writer) (*initData, error) {
	...
	return &initData{
		...
		ikniteConfig:            initOptions.ikniteCfg,
	}, nil
}
