...
[containerd](https://containerd.io/) is the container runtime. It is managed by
OpenRC and serves as the CRI (Container Runtime Interface) for Kubernetes.
