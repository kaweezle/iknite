...
func TestRunValidateApp_MissingDir(t *testing.T) {
	t.Parallel()
	err := runValidateApp(context.Background(), newMemFileExecutor(t), "/nonexistent", "")
	if err == nil {
...
func TestRunValidateApp_DirExistsError(t *testing.T) {
	...
	err := runValidateApp(context.Background(), fileExecutor, "/app", "")
...
func TestNewService(t *testing.T) {
	...
	svc := NewService(fs, testutil.NewLogger(&bytes.Buffer{}))
	require.NotNil(t, svc)
	require.NotNil(t, svc.FS)
